.data
message1: .asciiz "\nEnter 1st Number: "
message2: .asciiz "Select Operator: "
message3: .asciiz "\nEnter 2nd Number: "
message4: .asciiz "Result: "
message5: .asciiz "\nRemainder: "
message6: .asciiz "Invalid input"
Num1: .word 0:20
Num2: .word 0:20
Result: .word 7
remainder: .word 0
...
syscall
jal Exit
# remove \n or new line at the end of string of Num1
remove1:
lb $a3, Num1($s0) # Load character at index
 ...
 sb $0, Num1($s0) # Add the terminating character in its place
# remove \n or new line at the end of string of Num2
remove2:
lb $a3, Num2($s0) # Load character at index
 addi $s0,$s0,1 # Increment index
 bnez $a3,remove2 # Loop until the end of string is reached
 beq $a1,$s0,convert1 # Do not remove \n when it isn't present
 subiu $s0,$s0,2 # Backtrack index to '\n'
 sb $0, Num2($s0) # Add the terminating character in its place
 jal convert1
#DisplayNumb
