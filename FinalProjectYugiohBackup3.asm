...
beq $t6, 0, DisplayOpponentMonsterOne
beq $t6, 1, DisplayOpponentMonsterTwo
beq $t6, 2, DisplayOpponentMonsterThree
...
beq $t6, 0, DisplayOpponentMonsterOneAttack
beq $t6, 1, DisplayOpponentMonsterTwoAttack
beq $t6, 2, DisplayOpponentMonsterThreeAttack
