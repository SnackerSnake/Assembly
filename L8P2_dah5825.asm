.data
	...
	limit:	.space 4
	zero:	.float 0.0
	msg0: .asciiz "Enter number of floating point numbers (as an integer):"
	msg1: .asciiz "Enter floating point numbers:\n"  
...
.text
main:
#Print a message "Enter number of floating point numbers: ?"
	li $v0, 4       	 # load 4 into $v0 (for printing a string)        
	la $a0,msg0     	 # load address of string to register $a0     
	syscall         	 # print the corresponding string to console
# read number of floating point numbers to limit
	li $v0, 5       	 # load 5 into $v0 (for reading an integer)         
	syscall         	 # print the corresponding string to console
	sw $v0,limit

#Print a message "Enter floating point numbers:"
	li $v0, 4       	 # load 4 into $v0 (for printing a string)        
