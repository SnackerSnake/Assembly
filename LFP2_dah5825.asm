...
#I think I'm changing the design from 3-5 monster zones to one monster zone, and the hand limit from 5 to 3.
#Now the player can summon monsters from the first card in the hand and attack directly with them.
#I'm still missing to make monsters summonable from second and third position in the hand.
#I'm also missing to make the opponent summon so that monsters can battle.


#Notes from first submission:
